...
b = 0
path = r"C:\Users\rayso\Downloads\現實相片-20241101T052224Z-001\Data\Hypophyhalmichthys_fish"

s = r"C:\Users\rayso\Downloads\現實相片-20241101T052224Z-001\Data\Hypophyhalmichthys_fish\Hypophyhalmichthys_fish_14.png"
image = Image.open(s)
...
while b < 0.65:
    ...
    cv2.imwrite("C:/Users/rayso/Downloads/現實相片-20241101T052224Z-001/Data/" + name, image)

    os.system("C:/Users/rayso/Downloads/現實相片-20241101T052224Z-001/Data/" + str(b) + "_clear.jpg -n realesrgan-x4plus")
